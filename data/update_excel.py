...
ESP32_URL = "http://192.168.1.7/data"  # Replace with your ESP32 IP address

# Path to your Excel file
file_path = r"EXCEL PATH"  # Update this with the desired file path
...
def initialize_excel():
    try:
        ...
        if "Sensor Data" not in workbook.sheetnames:
            ...
            headers = ["Timestamp", "Temperature (°C)", "Humidity (%)", "Soil Moisture (%)", "Motion Status"]
...
def append_to_excel(data):
    try:
        ...
        new_row = [
            ...
            data.get("soilMoisture", "N/A"),
            "Motion Detected" if data.get("motion", False) else "No Motion"
        ]
